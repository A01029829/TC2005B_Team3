...
CREATE TABLE Partida(
  ...
  objetoPsala TINYINT,
  enemigosCDerrotadosParcial TINYINT,
  enemigosFDerrotadosParcial TINYINT,
  jefesDerrotadosParcial TINYINT,
  ...
  CONSTRAINT chk_enemigosCDerrotadosParcial CHECK (enemigosCDerrotadosParcial BETWEEN 0 AND 45),
  CONSTRAINT chk_enemigosFDerrotadosParcial CHECK (enemigosFDerrotadosParcial BETWEEN 0 AND 9),
  CONSTRAINT chk_jefesDerrotadosParcial CHECK (jefesDerrotadosParcial BETWEEN 0 AND 3)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Estadisticas(
  ...
  clase ENUM('Guerrero', 'Arquero', 'Hechicero'),
  enemigosCDerrotados TINYINT,
  enemigosFDerrotados TINYINT,
  jefesDerrotados TINYINT,
  causaMuerte ENUM('Maldicion', 'Vida'),
  tiempoTotal TIME DEFAULT 0,
  maldicionFinal DECIMAL(5,2),
  puntuacionFinal TINYINT DEFAULT 0,
  nivelFinal TINYINT DEFAULT 1,
  ...
  CONSTRAINT chk_causaMuerte CHECK (causaMuerte IN ('Maldicion', 'Vida')),
  CONSTRAINT chk_tiempoTotal CHECK (tiempoTotal BETWEEN '00:00:00' AND '00:10:00'),
  CONSTRAINT chk_maldicionFinal CHECK (maldicionFinal BETWEEN 0.00 AND 1.00),
  CONSTRAINT chk_puntuacionFinal CHECK (puntuacionFinal BETWEEN 0 AND 10200),
  CONSTRAINT chk_nivelFinal CHECK (nivelFinal BETWEEN 1 AND 3)
